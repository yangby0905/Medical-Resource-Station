        ...
        <div class="currentorder">
            <div class="currentorderdetail">
                ...
                <div class="prescription">
                    <div class="prescriptionicon">
                        <img class="prescriptioniconimg" src="img/prescriptiondetail/icon/icon.png" alt="icon">
                    </div>
                    <div class="prescriptiondetail">
                        <div class="prescriptiondetailtake">
                            <ul>
                                Lisinorpril 20mg Tablet PO(Oral) daily
