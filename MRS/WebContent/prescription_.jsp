    ...
    <div class="blank">
		...
		<%
        	...
        	try {
    			...
    			String sql = "SELECT appointment.ID, time, patient.name, description FROM patient INNER JOIN appointment ON patient.ID = "
    		+ "appointment.patientID INNER JOIN doctor ON appointment.doctorID = doctor.ID WHERE doctor.username = '"+ un +"' AND status = 'Confirmed'";
    			ResultSet rs = stmt.executeQuery(sql);
    			while(rs.next()){
    	%>
    	
			<form method="post" action="WritePrescription">
                <div>
