...
<body>
    ...
    <div class="blank">
		...
		<%
			String aID = request.getParameter("appointment_");
			int ID = 0;
			if(aID != null)
				ID = Integer.parseInt(aID);
		%>	
			
			<form method="post" action="SubmitPrescription">
			<div class="list">
		        <ul>
		            <li><img src="img/prescriptiondetail/icon/icon.png" alt="icon"></li>
		            <li>
		                Write a new prescription here: 
		                <br><br>
		                <input type="text" name="content" style="width:500px; height:25px;">
		...
		<%
			try {
				...
				String sql = "SELECT * FROM prescription WHERE appointmentID = '"+ ID +"' ORDER BY time";
