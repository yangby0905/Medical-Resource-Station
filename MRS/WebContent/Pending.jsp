...
<body>
    ...
    <!--The details about the appointments-->
    	...
    	<% 
    		...
    		+ "ON patient.ID = appointment.patientID INNER JOIN doctor ON appointment.doctorID = doctor.ID WHERE doctor.username = '"+ un +"' AND status = 'To be confirmed'";
    ...
    <div class="list">
        <ul>
            ...
            <form method="post" action="ManipulateAppointment">
            <li>
                ...
                <p>
	                ...
	                <input type="hidden" name="c" value="<%= rs.getInt(1) %>">
