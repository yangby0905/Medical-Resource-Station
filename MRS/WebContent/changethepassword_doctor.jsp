...
<body>
    ...
    <div class="blank">
        <div>
            <a href="forgotpassword_doctor.jsp"><img class="back" src="img/forgotpassword/back/back.png" alt="back"></a>
            
        </div>
        <form method="post" action="DoctorPassword">
        <div class="signup">
